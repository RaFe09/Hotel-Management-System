...
// Include CookieManager for form persistence
...
// Get saved form data from cookies if no POST data
$savedFormData = null;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if ($result['success']) {
            ...
            // Save form data to cookie for persistence on error
            $formDataToSave = [
        ...
        // Save form data to cookie even if validation fails
        $formDataToSave = [
            'room_type' => $data['room_type'] ?? '',
...
<body>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Auto-save form data to cookies as user types (debounced)
            let saveTimeout;
            ...
            function saveFormData() {
                ...
                // Save to cookie via AJAX or use a cookie library
                // For now, form will be saved on submit via PHP
            }
